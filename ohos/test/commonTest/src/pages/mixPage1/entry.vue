<template>
    ...
    ><text class="nav">mixPage1页面</text>
      <div>
        <text class="btn" @click="jumpPage('mixPage2')">push(mixPage2)</text>
...
import { pushPage } from "@/utils/index.js";
    export default {
        ...
        methods: {
            ...
            onviewappear() {
                console.log('onviewAppear mixPage1 ...')
            },
            onviewdisappear() {
                console.log('onviewDisappear mixPage1 ...')
            },
            navigatorPop() {
