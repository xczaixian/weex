<template>
    ...
    ><text class="nav">mixPage页面</text>
      <div>
        <text class="btn" @click="jumpPage('mixPage1')">push(mixPage1)</text>
...
import { pushPage } from "@/utils/index.js";
    export default {
        ...
        methods: {
            ...
            onviewappear() {
                console.log('onviewAppear mixPage ...')
            },
            onviewdisappear() {
                console.log('onviewDisappear mixPage ...')
            },
            navigatorPop() {
